...
│   │
│   ├── models/                  # Модели данных (для будущего использования)
│   │   └── __init__.py
│   │
│   ├── schemas/                 # Pydantic схемы валидации (для будущего использования)
│   │   └── __init__.py
│   │
...
Подготовлены директории для:
- **models/** — ORM модели (SQLAlchemy)
- **schemas/** — Pydantic валидация данных

Их можно заполнить при необходимости для замены текущих raw SQL запросов на ORM.
